...
THREEx.BulgeGeometry.prototype = Object.create(THREE.BufferGeometry.prototype);
  ...
  function drawLine(entity, data) {
    ...
    for (i = 0; i < entity.vertices.length; i++)
    {
      ...
      if (entity.vertices[i].bulge)
      {
        ...
        //   entity.vertices[i + 1]: geometry.vertices[0];
      ...
      else
      {
        ...
        var x = entity.vertices[i].x;
        var z = entity.vertices[i].y;
        
        points.push(new THREE.Vector3(x,z,0)) //照我的程序跑
